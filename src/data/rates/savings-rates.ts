...
export const bankSavingsRates: BankSavingsRate[] = [
  ...
  },
  {
    ...
    liquidity: "App-based transfers",
    bestFor: "",
    notes: "Main savings account advertised as offering up to 6% interest p.a.",
  },
  {
    bankName: "Tonik Bank",
  ...
  },
  {
    ...
    liquidity: "App-based transfers",
    bestFor: "",
    notes: "4% annual interest rate. Described as making money work 4 times harder than a regular savings account.",
  },
  {
    bankName: "Tonik Bank",
    ...
    liquidity: "App-based transfers",
    bestFor: "",
    notes: "Group savings account. No explicit interest rate stated on this page; rate inferred from context alongside Solo Stash. Rate not explicitly stated — treat with caution.",
  },
  {
    bankName: "MariBank",
