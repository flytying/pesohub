...
export const SAVINGS_RATES_UPDATED_AT = "2026-08-15";
...
export const bankSavingsRates: BankSavingsRate[] = [
  ...
  },
  {
    ...
    liquidity: "App-based transfers",
    bestFor: "",
    notes: "Up to 6% interest p.a. on the main Tonik Account (neobank savings account).",
  },
  {
    bankName: "Tonik Bank",
  ...
  },
  {
    ...
    liquidity: "App-based transfers",
    bestFor: "",
    notes: "4% annual interest rate on Solo Stash. Described as earning 4x more than a regular savings account.",
  },
  {
    bankName: "MariBank",
