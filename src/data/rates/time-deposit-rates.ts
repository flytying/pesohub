...
export const TIME_DEPOSIT_RATES_UPDATED_AT = "2026-05-15";
...
export const bankTimeDepositRates: BankTimeDepositRate[] = [
  {
    ...
    bestFor: "",
    notes: "Tonik advertises up to 8% annual interest rate on Time Deposits. A news headline from February 14, 2026 references a 6–7–8% tiered rate structure with 'No Conditions, No Catch, and Accessible to Everyone.' Specific term lengths and minimum deposit amounts are not stated on this page.",
  },
  {
    bankName: "CIMB",
