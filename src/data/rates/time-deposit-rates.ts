...
export const TIME_DEPOSIT_RATES_UPDATED_AT = "2026-06-01";
...
export const bankTimeDepositRates: BankTimeDepositRate[] = [
  {
    ...
    bestFor: "",
    notes: "Tonik advertises up to 8% annual interest rate on Time Deposits. A February 2026 news headline references tiered rates of 6–7–8% with 'no conditions, no catch, and accessible to everyone.' Specific term lengths and minimum deposit amounts are not explicitly stated on this page.",
  },
  {
    bankName: "CIMB",
