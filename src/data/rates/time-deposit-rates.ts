...
export const bankTimeDepositRates: BankTimeDepositRate[] = [
  ...
  },
  {
    ...
    taxNote: "Gross before 20% WHT",
    bestFor: "",
    notes: "Advertised on homepage as '5.5% annual interest rate on Time Deposits'. Specific term lengths and minimum deposit amounts not stated on this page. See /savings-cards/time-deposit for full details.",
  },
  {
    bankName: "CIMB",
