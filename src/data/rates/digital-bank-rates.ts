...
export const digitalBankRates: DigitalBankRate[] = [
  {
    ...
    transfers: "Fund transfers supported; zero-fee QRPH payments to 675,000+ merchants",
    limitsConditions: "No explicit minimum balance or cap stated on page",
    depositInsurance: "PDIC insured up to ₱1,000,000 per depositor",
    notes: "Up to 6% interest p.a. on Tonik Account. Also offers Solo Stash (4% p.a.), Group Stash (savings with a group), and Time Deposit (5.5% p.a.). Onboarding via app in ~5 minutes. Face ID / Touch ID login supported. First standalone digital bank in the Philippines to achieve profitability.",
  },
  {
    bankName: "Tonik Bank – Time Deposit",
    bestFor: "Fixed-term deposits seeking higher guaranteed returns",
    baseRate: 5.5,
    promoRate: null,
    cardAtmAccess: "Mastercard debit card with 3D Secure (Mastercard SecureCode); card lock/block and limit management available in-app",
    transfers: "Fund transfers supported; zero-fee QRPH payments to 675,000+ merchants",
    limitsConditions: "No explicit minimum or term length stated on page",
    depositInsurance: "PDIC insured up to ₱1,000,000 per depositor",
  ...
  },
  {
    ...
    limitsConditions: "No explicit minimum balance or cap stated on page",
    depositInsurance: "PDIC insured up to ₱1,000,000 per depositor",
    notes: "4% annual interest rate; described as earning 4x more than a regular savings account. Stash can have a photo/goal linked to it.",
  },
  {
    bankName: "Tonik Bank – Group Stash",
    bestFor: "Group/squad savings goals",
    baseRate: 4,
    promoRate: null,
    cardAtmAccess: "Mastercard debit card with 3D Secure (Mastercard SecureCode); card lock/block and limit management available in-app",
    transfers: "Fund transfers supported; zero-fee QRPH payments to 675,000+ merchants",
    limitsConditions: "No explicit minimum balance or cap stated on page",
    depositInsurance: "PDIC insured up to ₱1,000,000 per depositor",
    notes: "Group savings product; rate not explicitly stated on homepage but falls under the Stashes product line alongside Solo Stash (4% p.a.). Rate assumed consistent with Solo Stash based on page context.",
  },
  {
    bankName: "MariBank",
