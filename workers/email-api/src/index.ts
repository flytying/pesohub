    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; padding: 24px;">
      ...
      <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
        ...
        <tr>
          ...
          <td style="padding: 8px 12px; color: #0f172a;"><a href="mailto:${escapeHtml(data.email)}" style="color: #2180FF;">${escapeHtml(data.email)}</a></td>
        </tr>
        <tr>
  ...
  return `
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 560px; margin: 0 auto; padding: 24px;">
      ...
      <p style="margin-top: 24px; font-size: 12px; color: #94a3b8; text-align: center;">
        Generated by <a href="https://pesohub.ph" style="color: #2180FF; text-decoration: none;">PesoHub</a> — Practical Money Tools for Filipinos
      </p>
